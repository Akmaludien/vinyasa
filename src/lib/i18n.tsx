...
const dict = {
  id: {
    ...
    "tab.audit": "Audit",
    "tab.md": "DESIGN.md",
    "md.hero.eyebrow": "Hasil utama",
    "md.hero.title": "Design system situs ini",
    "md.hero.sub":
      "Satu dokumen berisi warna, tipografi, dan ukuran yang dipakai situs ini. Siap ditempel ke proyek anda.",
    "md.hero.copy": "Salin",
    "md.hero.copied": "Tersalin",
    "md.hero.download": "Unduh",
    "md.hero.full": "Atur bagian",
    "detail.show": "Lihat detail lengkap",
    "detail.hide": "Sembunyikan detail",
    "detail.sub": "Warna, tipografi, spacing, komponen, aksesibilitas, responsif, dan ekspor.",
    "tab.preview": "Preview",
    "tab.ai": "AI",
    "show_ai": "AI",
    ...
    "hero.eyebrow": "Buat DESIGN.md sekali klik",
    "hero.lead": "Bedah design system ",
    "hero.gradient": "situs mana pun",
    "hero.subtitle":
      "Tempel URL, dapat DESIGN.md. Warna, ukuran huruf, jarak, dan bentuknya sudah diputuskan, tinggal dipakai.",
    "home.urlLabel": "URL website",
    "home.scopeLabel": "Cakupan scan",
    "home.modeLabel": "Mode",
    "home.maxPages": "Maks halaman",
    "home.pagesUnit": "halaman",
    "home.settingsShow": "Ubah",
    "home.settingsHide": "Tutup",
    ...
    "scope.custom": "Tentukan sendiri berapa halaman yang dipindai.",
  ...
  en: {
    ...
    "tab.audit": "Audit",
    "tab.md": "DESIGN.md",
    "md.hero.eyebrow": "Main result",
    "md.hero.title": "This site's design system",
    "md.hero.sub":
      "One document with the colors, type, and sizing this site uses. Ready to paste into your project.",
    "md.hero.copy": "Copy",
    "md.hero.copied": "Copied",
    "md.hero.download": "Download",
    "md.hero.full": "Pick sections",
    "detail.show": "See the full breakdown",
    "detail.hide": "Hide the breakdown",
    "detail.sub": "Colors, typography, spacing, components, accessibility, responsive, and export.",
    "tab.preview": "Preview",
    "tab.ai": "AI",
    "show_ai": "AI",
    "nav.overview": "Overview",
    ...
    "hero.eyebrow": "Build DESIGN.md in one click",
    "hero.lead": "Reverse-engineer the design system of ",
    "hero.gradient": "any website",
    "hero.subtitle":
      "Paste a URL, get a DESIGN.md. Colors, type sizes, spacing and shapes are already decided, ready to use.",
    "home.urlLabel": "Website URL",
    "home.scopeLabel": "Scan scope",
    "home.modeLabel": "Mode",
    "home.maxPages": "Max pages",
    "home.pagesUnit": "pages",
    "home.settingsShow": "Change",
    "home.settingsHide": "Close",
    ...
    "scope.custom": "Set how many pages to scan yourself.",
